...
set tags=/home/google/workspace/tags  "ctags -R* 生成tags文件所在路径"
set autochdir

" YouCompleteMe
set runtimepath+=/home/google/.vim/YouCompleteMe					"/YouCompleteMe文件夹所在的路径" 
...
"c 文件添加文件信息快捷键
map <F3> :call TitleDet_c()<cr>
function AddTitle_c()
	call append(0,"/****************************************************************")
	call append(1,"*	Author       : guhaiming ")
	call append(2,"*	Last modified: ".strftime("%Y-%m-%d %H:%M"))
	call append(3,"*	Email        : 2427779305@qq.com")
	call append(4,"*	blog         : https://blog.csdn.net/go_home_look")
...
"脚本文件文件信息快捷键 #!bin/bash"
map <F5> :call TitleDet_sh()<cr>
